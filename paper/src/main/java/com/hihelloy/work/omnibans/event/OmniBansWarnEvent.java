...
/**
 * Fired by OmniBans on the main thread after a warn is stored and the
 ...
 */
public final class OmniBansWarnEvent extends Event {

    private static final HandlerList HANDLERS = new HandlerList();

    private final Punishment punishment;

    public OmniBansWarnEvent(Punishment punishment) {
        super(true);
