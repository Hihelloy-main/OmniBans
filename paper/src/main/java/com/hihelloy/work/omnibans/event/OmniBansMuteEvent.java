...
/**
 * Fired by OmniBans on the main thread after a mute is stored and the
 ...
 */
public final class OmniBansMuteEvent extends Event {

    private static final HandlerList HANDLERS = new HandlerList();

    private final Punishment punishment;

    public OmniBansMuteEvent(Punishment punishment) {
        super(true);
