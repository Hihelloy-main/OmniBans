...
/**
 * Fired by OmniBans on the main thread after a ban is stored and the
 ...
 */
public final class OmniBansBanEvent extends Event {

    private static final HandlerList HANDLERS = new HandlerList();

    private final Punishment punishment;

    public OmniBansBanEvent(Punishment punishment) {
        super(true);
